...
import com.example.paulina.menu_cliente.ContenedorComprobanteAdm
...
class PreTarifa : Fragment(R.layout.fragment_pre_tarifa) {
    ...
    private fun guardar(){
        ...
        if(precio == ""){
            ...
            findNavController().navigate(R.id.action_pre_Tarifa_to_pre_Tarifa2)
        }
    }
}
